...
public class Driver {
    ...
    public static void addShip() {
        ...
        System.out.print("Enter the number of balconies: ");
        int tBalcony=in.nextInt();
        System.out.print("Enter the number of oceanView rooms: ");
        int tOceanView=in.nextInt();
        System.out.print("Enter the number of suites: ");
        int tSuite=in.nextInt();
        System.out.print("Enter the number of interiors: ");
        int tInterior=in.nextInt();
        System.out.print("Is there in service? y/n: ");
        boolean tInService=in.next().charAt(0) == 'y';
    ...
    public static void printShipList(String listType) {
        ...
        if (listType == "name") {
            ...
            for (Ship eachShip: shipList)
                   if(eachShip.getShipList()) //whatever this function is called	
