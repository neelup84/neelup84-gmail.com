public class Cruise {
    ...
    System.out.println("Cruise Name- " + cruiseName);//Print cruise name
    System.out.println("Cruise Ship Name-" + cruiseShipName);//Print cruise shipname
    System.out.println("Departure Port-" + departurePort);//Print Departure Port
    System.out.println("Destination-" + destination);//Print Destination
    System.out.println("Return Port-" + returnPort);//Print Return port
