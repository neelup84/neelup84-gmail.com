...
public class Driver {
    ...
    public static void addShip() {
    	...
    	int shipRoomSuite = Integer.parseInt(newShipInput.nextLine());
    	
    	//get no.of rooms interior for the ship
    	System.out.println("Enter no.of interior cabins: ");
    	int shipRoomInterior= Integer.parseInt(newShipInput.nextLine());
    	
    	
    	
    	//get no.of rooms interior for the ship
    	System.out.println("Enter ship is in service?(yes/no): ");
